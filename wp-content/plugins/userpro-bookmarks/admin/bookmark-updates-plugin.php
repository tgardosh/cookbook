...
if( !class_exists('WPUpdatesPluginUpdater_1130') ) {
    class WPUpdatesPluginUpdater_1130 {
    	...
    	function __construct( $api_url, $plugin_path, $license_key = null ) {
    		...
    		add_filter( 'plugins_api', array(&$this, 'plugin_api_call'), 10, 4 );
    	...
    	function check_for_update( $transient ) {
    		...
    		if( is_object($response) && !empty($response) ) {
    			...
    			if( !$userpro->verify_purchase( userpro_fav_get_option('bookmark_envato_purchase_code'), '13z89fdcmr2ia646kphzg3bbz0jdpdja', 'DeluxeThemes', '6455170' ) ){
